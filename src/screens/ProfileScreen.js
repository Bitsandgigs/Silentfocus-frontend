    ...
    <SafeAreaView style={{flex: 1, backgroundColor: background}}>
      ...
      >
        ...
        <Section
          ...
          {isCalendarSynced ? (
            <>
              <Text style={[styles.providerText, {color: mutedText}]}>
                {calendarProvider}
              </Text>
...
const Field = ({label, value, color, textColor}) => {
  ...
  return (
    <View style={styles.rowHeader}>
      <Text style={[styles.label, {color: textColor || defaultLabelColor}]}>
        {label}
      </Text>
      <Text
        style={[
